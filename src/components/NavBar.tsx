...
const NavBar = ({ isOpen, click }: { isOpen: boolean; click: () => void }) => {
  return (
    <div className='flex z-30 top-0 left-0 lg:flex-col lg:min-h-full  h-screen w-full  max-w-[230px]  items-center border-r-[1.5px] border-r-slate-300'>
      <div className='flex px-2  items-center'>
        <img src={winc} alt='winc logo' className='max-h-[40px] my-4 ml-2 '></img>
        <p className='pl-2 w-[215px] text-lg font-bold text-[#4e8ac8] overflow-hidden'>
          Student Dashboard
        </p>
      </div>
