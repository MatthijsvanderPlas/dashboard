    ...
    <>
      <div className='flex relative p-4 flex-col mx-auto mt-4 mb-14  lg:w-4/5  max-w-[75ch]  leading-relaxed'>
        ...
        <div className='flex justify-around mt-10 mb-2 '>
          <SiHtml5 className='text-6xl text-[#e44b21]' />
        ...
        <Section title='Tailwind Css'>
          ...
          way I implement tailwind into my react apps, break up components even more. In general I
          like and enjoy working with the library and the amount of freedom and ease of
          customization it gives without having to resort to seperate css files.
        </Section>
